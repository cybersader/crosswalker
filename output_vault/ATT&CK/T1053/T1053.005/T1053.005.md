...
desc: "|-\n  Adversaries may abuse the Windows Task Scheduler to perform task scheduling\
  ...
  \ opened through the GUI within the Administrator Tools section of the Control Panel.(Citation:\
  \ Stack Overflow) In some cases, adversaries have used a .NET wrapper for the Windows\
  \ Task Scheduler, and alternatively, adversaries have used the Windows netapi32\
  \ library and [Windows Management Instrumentation](https://attack.mitre.org/techniques/T1047)\
  ...
  \ may also create \"hidden\" scheduled tasks (i.e. [Hide Artifacts](https://attack.mitre.org/techniques/T1564))\
