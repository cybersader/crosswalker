...
desc: Adversaries may target an Exchange server, Office 365, or Google Workspace to
  ...
  such as [MailSniper](https://attack.mitre.org/software/S0413) can be used to automate
