...
desc: "|-\n  Adversaries may attempt to make payloads difficult to discover and analyze\
  ...
  \ ClearSky MuddyWater Nov 2018)\n  \n  Source code payloads may also be encrypted,\
  \ encoded, and/or embedded within other files, such as those delivered as a [Phishing](https://attack.mitre.org/techniques/T1566).\
