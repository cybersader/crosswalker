---
title: 'Data Staged: Local Data Staging'
desc: "|-\n  Adversaries may stage collected data in a central location or directory\
  ...
  \ may also stage collected data in various available formats/locations of a system,\
  \ including local storage databases/repositories or the Windows Registry.(Citation:\
