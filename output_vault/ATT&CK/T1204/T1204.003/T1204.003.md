...
desc: "|-\n  Adversaries may rely on a user running a malicious image to facilitate\
  ...
  \ Summit Route Malicious AMIs)\n  \n  Adversaries may also name images a certain\
  \ way to increase the chance of users mistakenly deploying an instance or container\
  \ from the image (ex: [Match Legitimate Name or Location](https://attack.mitre.org/techniques/T1036/005)).(Citation:\
