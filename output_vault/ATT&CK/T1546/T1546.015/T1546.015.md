...
desc: "|-\n  Adversaries may establish persistence by executing malicious content\
  \ triggered by hijacked references to Component Object Model (COM) objects. COM\
  \ is a system within Windows to enable interaction between software components through\
  \ the operating system.(Citation: Microsoft Component Object Model)  References\
