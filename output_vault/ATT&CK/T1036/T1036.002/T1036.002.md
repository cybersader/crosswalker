...
desc: "|-\n  Adversaries may abuse the right-to-left override (RTLO or RLO) character\
  ...
  \ Infosecinstitute RTLO Technique)\n  \n  Adversaries may abuse the RTLO character\
  \ as a means of tricking a user into executing what they think is a benign file\
  \ type. A common use of this technique is with [Spearphishing Attachment](https://attack.mitre.org/techniques/T1566/001)/[Malicious\
