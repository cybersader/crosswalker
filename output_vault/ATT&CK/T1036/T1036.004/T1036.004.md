...
desc: "|-\n  Adversaries may attempt to manipulate the name of a task or service to\
  \ make it appear legitimate or benign. Tasks/services executed by the Task Scheduler\
  \ or systemd will typically be given a name and/or description.(Citation: TechNet\
  ...
  \ similar or identical to those of legitimate ones.\n  \n  Tasks or services contain\
  \ other fields, such as a description, that adversaries may attempt to make appear\
  \ legitimate.(Citation: Palo Alto Shamoon Nov 2016)(Citation: Fysbis Dr Web Analysis)"
---
