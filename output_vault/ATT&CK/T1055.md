...
desc: "|-\n  Adversaries may inject code into processes in order to evade process-based\
  ...
  \ inject code into a process, many of which abuse legitimate functionalities. These\
  \ implementations exist for every major OS but are typically platform specific.\
  \ \n  \n  More sophisticated samples may perform multiple process injections to\
  \ segment modules and further evade detection, utilizing named pipes or other inter-process\
