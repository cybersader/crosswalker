...
desc: "|-\n  Adversaries may backdoor web servers with web shells to establish persistent\
  ...
  \ Web server to allow an adversary to access the Web server as a gateway into a\
  \ network. A Web shell may provide a set of functions to execute or a command-line\
  \ interface on the system that hosts the Web server.(Citation: volexity_0day_sophos_FW)\n\
