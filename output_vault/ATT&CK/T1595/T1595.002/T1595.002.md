...
desc: "|-\n  Adversaries may scan victims for vulnerabilities that can be used during\
  ...
  \ of a specific exploit the adversary may seek to use.\n  \n  These scans may also\
  \ include more broad attempts to [Gather Victim Host Information](https://attack.mitre.org/techniques/T1592)\
  ...
  \ server banners, listening ports, or other network artifacts.(Citation: OWASP Vuln\
  \ Scanning) Information from these scans may reveal opportunities for other forms\
