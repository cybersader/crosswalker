...
desc: "|-\n  An adversary may create a new instance or virtual machine (VM) within\
  ...
  \ Mandiant M-Trends 2020)\n  \n  Creating a new instance may also allow an adversary\
  \ to carry out malicious activity within an environment without affecting the execution\
  \ of current running instances."
---
