...
desc: "|-\n  Adversaries may attempt to get a listing of software and software versions\
  \ that are installed on a system or in a cloud environment. Adversaries may use\
  \ the information from [Software Discovery](https://attack.mitre.org/techniques/T1518)\
  ...
  \ has a version of software that is vulnerable to [Exploitation for Privilege Escalation](https://attack.mitre.org/techniques/T1068)."
related_frameworks:
- '[[EAC0005]]'
- '[[EAC0006]]'
- '[[EAC0011]]'
