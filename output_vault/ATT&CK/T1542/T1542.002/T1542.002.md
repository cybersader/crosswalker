...
desc: "|-\n  Adversaries may modify component firmware to persist on systems. Some\
  ...
  \ install malicious firmware that will execute adversary code outside of the operating\
  ...
  \ and hard disk re-images, as well as a way to evade host software-based defenses\
