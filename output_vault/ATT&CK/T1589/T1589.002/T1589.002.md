...
desc: "|-\n  Adversaries may gather email addresses that can be used during targeting.\
  \ Even if internal instances exist, organizations may have public-facing email infrastructure\
  \ and addresses for employees.\n  \n  Adversaries may easily gather email addresses,\
  \ since they may be readily available and exposed via online or other accessible\
