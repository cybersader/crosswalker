...
desc: "|-\n  Adversaries may search within public scan databases for information about\
  ...
  \ as active IP addresses, hostnames, open ports, certificates, and even server banners.(Citation:\
  \ Shodan)\n  \n  Adversaries may search scan databases to gather actionable information.\
  \ Threat actors can use online resources and lookup tools to harvest information\
  \ from these services. Adversaries may seek information about their already identified\
  ...
  \ (ex: [Active Scanning](https://attack.mitre.org/techniques/T1595) or [Search Open\
  \ Websites/Domains](https://attack.mitre.org/techniques/T1593)), establishing operational\
  \ resources (ex: [Develop Capabilities](https://attack.mitre.org/techniques/T1587)\
