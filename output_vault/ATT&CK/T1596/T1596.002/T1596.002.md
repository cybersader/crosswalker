...
desc: "|-\n  Adversaries may search public WHOIS data for information about victims\
  \ that can be used during targeting. WHOIS data is stored by regional Internet registries\
  ...
  \ WHOIS)\n  \n  Adversaries may search WHOIS data to gather actionable information.\
  \ Threat actors can use online resources or command-line utilities to pillage through\
  \ WHOIS data for information about potential victims. Information from these sources\
