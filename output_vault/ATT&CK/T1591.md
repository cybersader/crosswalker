...
desc: "|-\n  Adversaries may gather information about the victim's organization that\
  \ can be used during targeting. Information about an organization may include a\
  \ variety of details, including the names of divisions/departments, specifics of\
  ...
  \ about an organization may also be exposed to adversaries via online or other accessible\
  ...
  \ access (ex: [Phishing](https://attack.mitre.org/techniques/T1566) or [Trusted\
