...
desc: "|-\n  Adversaries may alter data en route to storage or other systems in order\
  ...
  \ may be possible over a network connection or between system processes where there\
  \ is an opportunity deploy a tool that will intercept and change information. The\
  \ type of modification and the impact it will have depends on the target transmission\
