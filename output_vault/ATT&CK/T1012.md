...
desc: "|-\n  Adversaries may interact with the Windows Registry to gather information\
  ...
  \ a significant amount of information about the operating system, configuration,\
  \ software, and security.(Citation: Wikipedia Windows Registry) Information can\
  \ easily be queried using the [Reg](https://attack.mitre.org/software/S0075) utility,\
