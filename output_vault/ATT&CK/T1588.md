...
desc: "|-\n  Adversaries may buy and/or steal capabilities that can be used during\
  ...
  \ operations throughout numerous phases of the adversary lifecycle.\n  \n  In addition\
  ...
  \  \n  In addition to purchasing capabilities, adversaries may steal capabilities\
  \ from third-party entities (including other adversaries). This can include stealing\
