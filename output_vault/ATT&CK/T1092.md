...
desc: 'Adversaries can perform command and control between compromised hosts on potentially
  ...
  with the likelihood that an Internet-connected system was compromised first and
  the second through lateral movement by [Replication Through Removable Media](https://attack.mitre.org/techniques/T1091).
