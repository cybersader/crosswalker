...
desc: "|-\n  Adversaries may log user keystrokes to intercept credentials as the user\
  \ types them. Keylogging is likely to be used to acquire credentials for new access\
  \ opportunities when [OS Credential Dumping](https://attack.mitre.org/techniques/T1003)\
