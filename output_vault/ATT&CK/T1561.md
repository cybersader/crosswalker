---
title: Disk Wipe
desc: "|-\n  Adversaries may wipe or corrupt raw disk data on specific systems or\
  \ in large numbers in a network to interrupt availability to system and network\
  ...
  \ Blockbuster Destructive Malware)\n  \n  On network devices, adversaries may wipe\
  \ configuration files and other data from the device using [Network Device CLI](https://attack.mitre.org/techniques/T1059/008)\
