...
desc: "|-\n  Adversaries may compromise third-party Virtual Private Servers (VPSs)\
  ...
  \ NSA NCSC Turla OilRig)\n  \n  Compromising a VPS for use in later stages of the\
  \ adversary lifecycle, such as Command and Control, can allow adversaries to benefit\
  \ from the ubiquity and trust associated with higher reputation cloud service providers\
  \ as well as that added by the compromised third-party."
---
