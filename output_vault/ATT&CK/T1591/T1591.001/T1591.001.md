...
desc: "|-\n  Adversaries may gather the victim's physical location(s) that can be\
  \ used during targeting. Information about physical locations of a target organization\
  ...
  \ via online or other accessible data sets (ex: [Search Victim-Owned Websites](https://attack.mitre.org/techniques/T1594)\
  \ or [Social Media](https://attack.mitre.org/techniques/T1593/001)).(Citation: ThreatPost\
  \ Broadvoice Leak)(Citation: SEC EDGAR Search) Gathering this information may reveal\
