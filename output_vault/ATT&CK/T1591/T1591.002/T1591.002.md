...
desc: "|-\n  Adversaries may gather information about the victim's business relationships\
  ...
  \ also reveal supply chains and shipment paths for the victim's hardware and software\
  ...
  \ Information about business relationships may also be exposed to adversaries via\
  \ online or other accessible data sets (ex: [Social Media](https://attack.mitre.org/techniques/T1593/001)\
