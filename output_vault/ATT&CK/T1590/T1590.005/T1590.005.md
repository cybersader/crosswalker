---
title: 'Gather Victim Network Information: IP Addresses'
desc: "|-\n  Adversaries may gather the victim's IP addresses that can be used during\
  \ targeting. Public IP addresses may be allocated to organizations by block, or\
  \ a range of sequential addresses. Information about assigned IP addresses may include\
  \ a variety of details, such as which IP addresses are in use. IP addresses may\
  ...
  \ in various ways, such as direct collection actions via [Active Scanning](https://attack.mitre.org/techniques/T1595)\
  \ or [Phishing for Information](https://attack.mitre.org/techniques/T1598). Information\
  \ about assigned IP addresses may also be exposed to adversaries via online or other\
