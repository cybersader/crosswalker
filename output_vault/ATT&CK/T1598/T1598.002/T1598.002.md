...
desc: "|-\n  Adversaries may send spearphishing messages with a malicious attachment\
  ...
  \ In this scenario, adversaries attach a file to the spearphishing email and usually\
  \ rely upon the recipient populating information then returning the file.(Citation:\
  \ Sophos Attachment)(Citation: GitHub Phishery) The text of the spearphishing email\
  ...
  \ information from previous reconnaissance efforts (ex: [Search Open Websites/Domains](https://attack.mitre.org/techniques/T1593)\
