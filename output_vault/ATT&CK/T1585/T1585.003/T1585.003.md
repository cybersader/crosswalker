...
desc: "|-\n  Adversaries may create accounts with cloud providers that can be used\
  \ during targeting. Adversaries can use cloud accounts to further their operations,\
  ...
  \ infrastructure. Establishing cloud accounts may allow adversaries to develop sophisticated\
