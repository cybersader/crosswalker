...
desc: "|-\n  Adversaries may use password cracking to attempt to recover usable credentials,\
  ...
  \ are obtained. [OS Credential Dumping](https://attack.mitre.org/techniques/T1003)\
  ...
  \ Further,  adversaries may leverage [Data from Configuration Repository](https://attack.mitre.org/techniques/T1602)\
  ...
  \ of the target network.(Citation: Wikipedia Password cracking) The resulting plaintext\
  \ password resulting from a successfully cracked hash may be used to log into systems,\
