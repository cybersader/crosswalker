...
desc: "|-\n  Adversaries may gather information about the victim's host software that\
  \ can be used during targeting. Information about installed software may include\
  \ a variety of details such as types and versions on specific hosts, as well as\
  \ the presence of additional components that might be indicative of added defensive\
  ...
  \ or [Obtain Capabilities](https://attack.mitre.org/techniques/T1588)), and/or for\
