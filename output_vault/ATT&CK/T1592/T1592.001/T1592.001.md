...
desc: "|-\n  Adversaries may gather information about the victim's host hardware that\
  \ can be used during targeting. Information about hardware infrastructure may include\
  ...
  \ access (ex: [Compromise Hardware Supply Chain](https://attack.mitre.org/techniques/T1195/003)\
