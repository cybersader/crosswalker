...
desc: 'Adversaries may encode data with a standard data encoding system to make the
  ...
  Unicode, hexadecimal, Base64, and MIME.(Citation: Wikipedia Binary-to-text Encoding)(Citation:
