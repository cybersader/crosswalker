...
- **[Import wizard](/crosswalker/features/import-wizard/)** with 4-step workflow: file select, column config, preview, generate
...
- **[Config system](/crosswalker/features/config-system/)** — save, load, and match import configurations with fingerprint-based matching
- **[Generation engine](/crosswalker/features/generation-engine/)** — creates folder hierarchies and markdown notes with `_crosswalker` metadata
