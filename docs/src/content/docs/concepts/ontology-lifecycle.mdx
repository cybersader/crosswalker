...
.ol-lifecycle-ring > * { margin-top: 0 !important; }
.ol-phase {
  display: flex;
...
a.ol-phase:hover .ol-phase-card {
...
<div class="ol-lifecycle-ring" role="img" aria-label="Ontology lifecycle: Acquire, Import, Enrich, Maintain, Share, cycling back to Acquire">
  ...
  <div class="ol-arrow">→</div>
  <a href="#maintain" class="ol-phase">
    <div class="ol-phase-card ol-maintain" style="position:relative">
